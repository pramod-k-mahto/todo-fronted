...
async function myupdate(userId, decodedText) {
  ...
  id.innerHTML = `
        <form id="updateForm" action="https://todo-backend-jsht.onrender.com/todolist/update/${userId}" method="POST">
...
async function update(userId) {
  ...
  try {
    const response = await fetch(
      `https://todo-backend-jsht.onrender.com/todolist/update/${userId}`,
      {
        method: "post",
        headers: {
